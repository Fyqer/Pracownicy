	 ...
	 void bazaPracownicy::usunaktualny()
{
   ...
   char* dt = ctime(&now);
    ...
    if(fin.is_open())
        ...
        fout<<"Data usuniecia :"<<dt<< "\t \n "<<"Imie:"<< tab[current].getNazwa();
        fout<< "     "; 
         fout<<"miejscowosc:"<< tab[current].getMiejscowosc();
         fout<< "     ";
          fout<<"wiek:"<<tab[current].getWiek();
          fout<< "     ";
           fout<<"stanowisko:"<< tab[current].getStanowisko();
            fout<< "     ";
            fout<< "  \n  \n  ";
...
bazaPracownicy baza(rozmiar);
 ...
 printf("******************************************************\n");
	cout <<green<<" \t \t 1.Dodaj pracownika	"<<endl;
		...
		cout <<white<< " \t \t 6.Wyszukaj pracownikow"<<endl;
		cout<<white<< " \t \t 7.Kosz"<<endl;

		cout <<red<< " \t \t 8.Wyjdz"<<endl;
    ...
    goto glownylabel;
		...
		goto labeltrzy;
                    ...
                    case '7' :
                         ...
                         {
                             cout<<red<<"  \t \t Aktualnie Kosz zawiera"<<white;
                             std::ifstream file("Kosz.txt");
    std::string str; 
